...
import { ArrowLeft, Calculator, ChevronDown, Plus, Minus, ToggleRight } from 'react-native-feather';
...
const InputScreen = () => {
  ...
  const [formState, setFormState] = useState({
    ...
    drainageArea: '',
    streamGradient: '',
    region: 'Coastal BC - Vancouver Island',
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  Alert.alert(
                    ...
                    [
                      { 
                        text: 'Coastal BC - Vancouver Island', 
                        onPress: () => updateFormValue('region', 'Coastal BC - Vancouver Island')
                      },
                      { 
                        text: 'Interior BC', 
            ...
            <View style={styles.inputContainer}>
              <View style={styles.inputHeader}>
                ...
                <View style={styles.inputControls}>
                  ...
                  >
                    <Minus size={16} color={formState.topWidths.length > 1 ? COLORS.danger : COLORS.gray[400]} />
                  </TouchableOpacity>
                </View>
              </View>
              ...
              <View style={styles.inputHeader}>
                ...
                <View style={styles.inputControls}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={removeDepth}
                  >
                    <Minus size={16} color={formState.depths.length > 1 ? COLORS.danger : COLORS.gray[400]} />
                  </TouchableOpacity>
                </View>
              </View>
        ...
        <View style={styles.footer}>
          ...
          >
            {isCalculating ? (
              ...
              <>
                <Calculator size={20} color={COLORS.white} style={styles.calculateIcon} />
